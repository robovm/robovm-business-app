...
import org.robovm.samples.contractr.android.adapter.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public void setUp(int fragmentId, DrawerLayout drawerLayout, final Toolbar toolbar) {
        ...
        drawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.drawer_open,
